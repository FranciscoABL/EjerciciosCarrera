...
//Nota:
/*Para arreglar lo de comparar con el compareTo al ser String el compareTo compara solo los codigo Ascci mostrando un 40 priemro ante un 5 ya que empieza
